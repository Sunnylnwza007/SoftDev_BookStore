...
public class CartDAO {
    ...
    public Cart getCart(String username) {
        ...
        Document findCart = new Document("user", username);
    ...
    public void insertAddress(Address address, String username) {
        ...
        Document findAddress = new Document("user", username);
        Document insert = new Document("user", username).append("houseNum", address.getHouseNum()).append("villageNo", address.getVillageNo())
